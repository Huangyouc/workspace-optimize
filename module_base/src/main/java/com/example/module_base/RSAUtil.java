...
/**
 * @Description:RSA加密工具
 * 核心：项目本地存储publicKey的字符串或者接口下发这个字符串
 * 然后通过(String encryptingStr, String publicKeyStr)对目标字符串encryptingStr加密
 *  其他三种情况同理
 */
public class RSAUtil {
    ...
    public static String encryptBase64(byte[] key) {
        return new String(Base64.encodeToString(key,Base64.NO_WRAP));
    }

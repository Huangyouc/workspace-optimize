...
//		String regExp = "^[1][0-9]{10}$";
	...
	public static boolean isEmptyJava(String str) {
		return str == null || str.length() == 0||str.equals("null");
	}
	public static boolean isNotEmptyJava(String str) {
		return !StringUtils.isEmptyJava(str);
	}
	...
	/**
	 * double类型转String不带无用的0
	 * @param num
	 * @return
	 */
	public static String doubleTransStr(double num){

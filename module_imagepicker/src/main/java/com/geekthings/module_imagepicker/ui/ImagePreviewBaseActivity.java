...
import com.geekthings.module_imagepicker.adapter.ImagePageAdapter;
...
import com.geekthings.module_imagepicker.view.HackyViewPager;
...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageFolder =  getIntent().getParcelableExtra(ImagePicker.EXTRA_IMAGE_ITEMS);

        mImageItems = mImageFolder.images;
